...
* Conduct keyword analysis using domain titles, descriptions, and content from data provider,  - done
* github for .tech, .store, and .fun -- question -- not enough renewal data
