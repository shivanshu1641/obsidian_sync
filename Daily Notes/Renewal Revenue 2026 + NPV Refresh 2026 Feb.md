...
SELECT domain_id, 
        ...
        AND tld = "tech"
        AND LOWER(client_shortname) = "startupleague_dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-03-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
...
SELECT domain_id, 
        ...
        AND tld = "press"
        AND LOWER(client_shortname) = "dotpress_dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-01-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
...
SELECT domain_id, 
        ...
        AND DATE(creation_date) BETWEEN "2025-01-08" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.3 as first_renew_pred, 
        0.3 as second_renew_pred, 
        0.65 as subsequent_renew_pred, 
        ...
        AND tld = "site"
        AND LOWER(client_shortname) = "dotsite_dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-04-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.1 as first_renew_pred, 
        0.5 as second_renew_pred, 
        0.77 as subsequent_renew_pred, 
        ...
        AND DATE(creation_date) BETWEEN "2023-01-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.1 as first_renew_pred, 
        0.5 as second_renew_pred, 
        0.77 as subsequent_renew_pred, 
...
SELECT domain_id, 
        ...
        AND DATE(creation_date) BETWEEN "2025-01-09" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.01 as first_renew_pred, 
        0.45 as second_renew_pred, 
        0.7 as subsequent_renew_pred, 
...
SELECT domain_id, 
        ...
        AND tld = "online"
        AND LOWER(client_shortname) = "dotserve inc"
        AND DATE(creation_date) BETWEEN "2023-07-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
...
SELECT domain_id, 
        ...
        AND tld = "site"
        AND LOWER(client_shortname) = "dotserve inc"
        AND DATE(creation_date) BETWEEN "2023-10-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        null as first_renew_pred, 
        null as second_renew_pred, 
        null as subsequent_renew_pred, 
...
SELECT domain_id, 
        ...
        AND tld = "store"
        AND LOWER(client_shortname) = "storedomains_dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-10-12" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.03 as first_renew_pred, 
        0.5 as second_renew_pred, 
        0.77 as subsequent_renew_pred, 
        ...
        AND tld = "tech"
        AND LOWER(client_shortname) = "dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-11-27" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        0.2 as first_renew_pred, 
        0.62 as second_renew_pred, 
        0.78 as subsequent_renew_pred, 
...
SELECT domain_id, 
        ...
        AND tld = "store"
        AND LOWER(client_shortname) = "dotserve inc"
        AND DATE(creation_date) BETWEEN "2024-12-27" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        null as first_renew_pred, 
        null as second_renew_pred, 
        null as subsequent_renew_pred, 
...
SELECT domain_id, 
        ...
        AND DATE(creation_date) BETWEEN "2025-01-01" AND "2026-12-31" UNION ALL 
SELECT domain_id, 
        ...
        AND DATE(creation_date) BETWEEN "2025-01-01" AND "2026-12-31";


        UPDATE
        npv_data.newreg_predictions_non_dp_20260204 a
        SET
      ...
      LEFT JOIN (
        ...
        FROM
          UNNEST(GENERATE_ARRAY(3, (
              ...
              FROM
                npv_data.newreg_predictions_non_dp_20260204) + 3)) AS renewed_count) y
      ON
        TRUE
      UNION ALL
      SELECT
...
UNION ALL
      ...
      LEFT JOIN (
        SELECT * FROM UNNEST(GENERATE_ARRAY(3, (SELECT MAX(renewed_count) FROM npv_data.newreg_predictions_non_dp_20260204) + 3)) AS renewed_count
      ) y
      ON TRUE
